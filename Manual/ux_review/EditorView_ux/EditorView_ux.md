...
![Opening the file chooser ui](01_browse_for_file.png)
...
![Problem saved successfully](04_problem_saved_successfully.png)

The editor view will then close, and the user will be brought back to the setter's welcome view.

![Returned to setter welcome view](06_returned_to_setter_welcome.png)